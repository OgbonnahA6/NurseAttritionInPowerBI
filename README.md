...
- **3. Emerging Patterns**
  - **High-Risk Groups:**
    - **Tenure:**
  - First-year nurses exhibit the highest attrition rate at **41.7%**, highlighting onboarding challenges.
    - **Overtime:**
    - Nurses working overtime for **>20 hours/month** report an attrition rate of **32.6%**, significantly higher than the average.
...
- **4. Patterns in Demographics**
  - **Age Groups:**
    - Nurses **under 25 years old** show higher attrition rates **(40%)** compared to other age groups.
  - **Education:**
    - Nurses with bachelor’s degrees experience higher turnover **(15.6%)** compared to those with advanced degrees **(11.5%)**.
________________________________________
...
- **1. Job Satisfaction**
  ...
  - **Average satisfaction score: 68/100**.
    - Nurses with satisfaction scores below 50/100 are more likely to leave, with an attrition rate of **35.4%** compared to **9.2%** for those scoring above 50.
  - **Correlation:**
    - A strong negative correlation **(R = -0.65)** exists between satisfaction scores and attrition, indicating that lower satisfaction leads to higher turnover.
  - **Patterns:**
    - Departments with higher satisfaction scores (e.g., Cardiology) have lower attrition rates compared to high-stress units like Maternity.
________________________________________
- **2. Work Environment**
  - **Overtime Hours:**
    - Nurses working overtime for >20 hours/month have an attrition rate of **32.6%**, significantly higher than the organizational average of **15.6%**.
    - A clear trend shows that attrition increases as overtime hours rise.
  - **High-Stress Units:**
    - Maternity and Cardiology departments have the highest attrition rates (**14.5% and 13.8%**, respectively), linked to emotionally and physically demanding environments.
________________________________________
- **3. Compensation**
  - **Attrition by Income Level:**
    - Nurses earning in the bottom income quartile experience an attrition rate of **26.6%** compared to **8.1%** for those in the top quartile.
  - **Salary Disparities:**
    - Departments with perceived lower salary transparency, such as Maternity, report higher turnover.
  - **Retention Bonuses:**
    - In departments where bonuses were provided, attrition temporarily dropped by **1.5%**.
________________________________________
- **4. Workload**
  - **Tenure and Workload Impact:**
    - First-year nurses have the highest attrition rate at **41.7%**, indicating challenges with onboarding and acclimatization.
    - Workload imbalances, particularly in high-stress units, exacerbate dissatisfaction and increase turnover.
________________________________________
- **5. Emerging Patterns**
  - **High-Risk Groups:**
    - Nurses **under 25** years old and those with **bachelor’s degrees** experience disproportionately high attrition rates (**40% and 15.6%**, respectively).
...
- **2.	Compensation Enhancements:**
  - Offer competitive salaries and periodic raises based on performance and tenure.
  - Provide financial incentives for nurses in high-stress units.
- **3.	Career Growth Initiatives:**
  - Fund advanced education and certifications.
  - Introduce leadership pathways for high-performing nurses.
- **4.	Improve Organizational Culture:**
  - Train managers to foster supportive relationships.
  - Offer flexible schedules and mental health resources to improve work-life balance.
- **5.	Target High-Risk Segments:**
  - Develop specialized onboarding programs for new hires.
  - Provide retention bonuses and recognition for long-serving employees.
________________________________________
## E.	Implementation Roadmap
- **1.	Short-Term Actions:**
  - Address workload disparities through immediate staffing adjustments.
  - Enhance salary structures for low-income nurses.
- **2.	Long-Term Actions:**
  - Develop professional growth programs.
  - Implement wellness initiatives and managerial training.
________________________________________
